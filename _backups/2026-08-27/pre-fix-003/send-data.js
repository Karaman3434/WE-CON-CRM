/* BACKUP — WE-CON-CRM
   Source branch: main
   Source commit: 4e350fc8d060e2869bc29ed66ee34cdb30975e9d
   Source file: send-data.js
   Purpose: exact pre-change recovery copy before P0 transaction work.
   DO NOT LOAD THIS FILE AS APPLICATION CODE.
*/
  ...
  function kaydet(tip, musteri, sepetUrunleri, kur, kdv, adresler, geriBildir){
    try{
      var urunlerKaydi = sepetUrunleri.map(function(u){
        ...
        return {
          ad: u.ad || "İsimsiz Ürün", berta: u.berta || "", abas: u.abas || "",
          listeFiyat: u.listeFiyat || 0, dipFiyat: u.dipFiyat || 0, iskonto: u.iskonto || 0,
          adet: u.adet || 0, iskBirim: h.iskontoluFiyat || 0, toplamEuro: h.toplamEuro || 0
        };
      });
      ...
      db.ref("arsiv/" + tip).once("value").then(function(snap){
        ...
        if(eslesenIdx >= 0){
          ...
          eskiKayit.urunler = urunlerKaydi; eskiKayit.revizeZamani = simdi;
          ...
          otomatikRevizeMi = true; kaydedilenKayit = eskiKayit;
        } else {
          ...
          kaydedilenKayit = {
            ...
            musteri: musteri.ad, musteriId: musteri.id || null, sehir: musteri.sehir || "", mod: tip, urunler: urunlerKaydi,
        ...
        return db.ref("arsiv/" + tip).set(liste).then(function(){ return {kayit:kaydedilenKayit, revizeMi:otomatikRevizeMi}; });
      }).then(function(sonuc){ geriBildir(true, sonuc.kayit, sonuc.revizeMi); })
      .catch(function(err){ console.error("Arşive kaydetme hatası:", err); geriBildir(false, err); });
    }catch(e){ console.error("Kaydet hatası:", e); geriBildir(false, e); }
  }
